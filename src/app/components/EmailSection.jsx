...
const EmailSection = () => {
    ...
    return (
        <section id='contact' className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
            <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-700 to-transparent rounded-full h-80 w-80 -z-0 blur-lg absolute top-full -left-4 transform -translate-x-1/2 -translate-y-1/2'></div>
            <div className='z-10'>
                ...
                <div className='socials flex flex-row gap-2'>
                    <Link href="https://github.com/dan-carvalhoshrn">
                        <Image src={GithubIcon} alt='Github Icon' />
                    </Link>
                    <Link href="https://www.linkedin.com/in/daniel-carvalhosh/">
            ...
            <div>
                <form className='flex flex-col' onSubmit={handleSubmit}>
                    ...
                    <button
                        type='submit'
                        className='bg-primary-600 hover:bg-primary-700 text-white font-medium py-2.5 px-5 rounded-lg w-full z-10'
                    >
                        Send Message
                    </button>
                    {
                        emailSubmitted &&  (
                            <p className='text-green-500 text-sm mt-2 z-10'>
